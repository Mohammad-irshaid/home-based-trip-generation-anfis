...
Irshaid, M., & Abu‑Eisheh, S. (2023). Application of adaptive neuro‑fuzzy inference system in modelling home‑based trip generation. (Available in this repository as Application of ANFIS in Modelling Home-Based Trip Generation.pdf)
...
Visualisation tools for membership functions, training convergence, and error analysis.
